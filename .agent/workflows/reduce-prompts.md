...
Reduce the size of prompts, rules, workflows by consolidating repeated content, using concise notation, and applying optimization techniques while maintaining clarity and completeness.
